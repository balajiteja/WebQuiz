...
public class RegistrationActionTest extends TestCase {
	...
	public void testRedundantEntry() {
		...
		assertEquals("input", output);
		retrieveDbInfo.deleteFromTable("user", "userId", "testUserId23");
	}
	...
	public void testValidatePassword() {
		...
		assertEquals("input", output);
		retrieveDbInfo.deleteFromTable("user", "userId", "testUserId21");
	...
	public void testValidEntry() {
		...
		retrieveDbInfo.deleteFromTable("user", "userId", "testUserId123");
	}
}
