...
QZ.QuizMaker = new Class( {
	...
	_addAnsweringOptions : function() {
		...
		for(var i=0;i<options.length;i++) {
			var el = new Element('div');
			el.addClass('QZ-question-option');

			var option = options[i];
			var id = 'QZ-quiz-option-' + this.internal.questionIndex + '-' + i;

			var checkbox = new Element('input', {
				name : 'QZ-quiz-options',
				id : id,
	...
	_addAnswerButton : function() {
		var el = new Element('div');
		el.addClass('QZ-answer-button-container');
